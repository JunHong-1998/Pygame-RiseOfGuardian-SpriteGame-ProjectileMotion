...
class Level2:
    ...
    def __init__(self, win, love, score, mute):
        ...
        self.enermy6 = enermy01(1750, 450, 60, 110, 1)
        self.enermy7 = enermy01(1820, 450, 60, 110, 1)
        self.enermy8 = enermy01(1890, 450, 60, 110, 1)
        self.enermy9 = enermy01(1960, 450, 60, 110, 1)
        self.block1 = block(1087, 452, 57, 106, 1)
        self.block2 = block(880, 452, 57, 106, 1)
        self.block3 = block(675, 452, 57, 106, 1)
        self.block4 = block(470, 452, 57, 106, 1)
        ...
        self.enermys = [self.block1, self.enermy1, self.enermy2, self.enermy3, self.enermy4, self.enermy5,
                        self.enermy6, self.enermy7, self.enermy8, self.enermy9]
    ...
    def redrawWindow(self):
        ...
        text = Level2.font.render('LEVEL ' + str(self.level) + ' / ' + 'WAVE ' + str(self.wave + 1), 1, (0, 0, 0))
        self.win.blit(text, (500, 10))
        text = Level2.font.render(str(self.score), 1, (0, 0, 0))
        self.win.blit(text, (1230, 710))
        text = Level2.font.render(str(int(self.timeleft)), 1, (255, 0, 0))
        ...
        self.win.blit(Level2.hole, (0, 442))
    ...
    def RUN(self):
        while self.run:
            self.clocktime += Level2.clock.tick_busy_loop(45)
            ...
            if self.wave < 5:
                ...
                for i in range(1, len(self.enermys)):
                    if self.enermys[i].x > self.enermys[i-1].x + self.distance:
                        self.enermys[i].left()
            ...
            if self.enermy1.health <= 0 and self.enermy2.health <= 0 and self.enermy3.health <= 0 \
                    ...
                    and self.enermy7.health <= 0 and self.enermy8.health <= 0 and self.enermy9.health <= 0\
