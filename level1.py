...
class Level1:
    ...
    def redrawWindow(self):
        ...
        text = Level1.font.render('LEVEL ' + str(self.level) + ' / ' + 'WAVE ' + str(self.wave + 1), 1, (0, 0, 0))
        self.win.blit(text, (500, 10))
        text = Level1.font.render(str(self.score), 1, (0, 0, 0))
        self.win.blit(text, (1230, 710))
        text = Level1.font.render(str(int(self.timeleft)), 1, (255, 0, 0))
        ...
        self.win.blit(Level1.hole, (0, 442))
    ...
    def RUN(self):
        while self.run:
            self.clocktime += Level1.clock.tick_busy_loop(45)
            ...
            if self.enermy1.health <= 0 and self.enermy2.health <= 0 and self.enermy3.health <= 0 \
                    and self.enermy4.health <= 0 and self.enermy5.health <= 0\
